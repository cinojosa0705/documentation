...
When a position is executed, if a callback target was specified in the request, this function is called on the target contract to notify it of the execution result.
